<template id="modal_catalog-published">
  <div class="modal-content catalog-published">
    <div class="modal-body clearfix">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-12">
            <div class="catalog-published-block">
              ...
              <div class="text-wrapper">
                <div class="text-title">Поздравляем!</div>
                <div class="text-small">Ваш каталог был создан, и после модерации будет
                  опубликован на сайте Stocker!</div>
              </div>
...
<script src="./modal_catalog-published.js"></script>
