    ...
    <div class="fixed-menu catalog-creating-menu">
      <a class="logo-full">
        ...
        <button v-for="step in steps"
                ...
                type="button">{{step.name}}</button>
      <div class="languages-wrapper">
        <nav class="languages">
          <ul>
            <li class="languages-item is-active">Ру</li>
          </ul>
        </nav>
        <div class="languages-menu">
          <nav class="languages-menu-main">
            <ul>
              <li class="languages-menu-item"><a href="#">Ук</a></li>
            </ul>
          </nav>
        </div>
      </div>
